...
public class caketest_result3_Activity extends AppCompatActivity {

    private InterstitialAd mInterstitialAd;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_caketest_result3);
        ...
        caketest_list.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(caketest_result3_Activity.this);
                } else {

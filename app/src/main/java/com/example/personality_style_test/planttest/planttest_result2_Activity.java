...
public class planttest_result2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_planttest_result2);
        ...
        planttest_list.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(planttest_result2_Activity.this);
                } else {

...
public class colortest_result1_Activity extends AppCompatActivity {

    private InterstitialAd mInterstitialAd;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_colortest_result1);
        ...
        colortest_list.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(colortest_result1_Activity.this);
                } else {
